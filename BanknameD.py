...
def NameRecog():
    import os
    CUSTOM_MODEL_NAME = 'CompanyName'
    TF_RECORD_SCRIPT_NAME = 'generate_tfrecord.py'
    LABEL_MAP_NAME = 'label_CompanyName_map.pbtxt'
    ...
    ckpt.restore(os.path.join(
        paths['CHECKPOINT_PATH'], 'ckpt-6')).expect_partial()
    ...
    name_written1 = ' '.join(str(e) for e in NAME_LABEL)

    global name_written
    name_written = name_written1
